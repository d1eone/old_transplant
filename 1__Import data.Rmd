...
txp= fromJSON(work.txp)
txp$Transplant = 1
txp$PGC_Status = txp$pulmonary_genetics_center_questionnaire_complete
txp$Herlihy_Status = txp$herlihy_questionnaire_complete
txp$SGRQ_Status = txp$ipf_questionnaire_complete
```
