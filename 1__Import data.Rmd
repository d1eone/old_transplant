...
PPMR$TransplantID = rename(PPMR,c(TransplantID = log_transplant_id, PPMR_ID = subject_id, ConsentDATE = transp_cons_dat))  
...
txp = select(txp,c(TransplantID,MRN,PGC_Status,Herlihy_Status,SGRQ_Status,PGCS_Status,TransplantStudy,emailAVAIL,email,elig_dx,Deceased))
```
