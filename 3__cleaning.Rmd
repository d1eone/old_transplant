...
SmHx$Yr.Smoke.Start_Txp = as.integer(suppressWarnings(format(( SmHx$DOB + SmHx$SmokeAgeStart*365.25 ), "%Y")))
SmHx$Yr.Smoke.Stop_Txp = as.integer(suppressWarnings(format(( SmHx$DOB + SmHx$SmokeAgeStop*365.25 ), "%Y")))
...
SmokingDF = select(SmHx,TransplantID, MRN, DOB, ConsentDATE, EverSmoked, AvgDailyCigs, AgeStartSmoking,AgeStopSmoking,Yr.Smoke.Start, Yr.Smoke.Stop)
```
