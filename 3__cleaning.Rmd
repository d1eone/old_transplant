...
```{r List of Values for Age of Smoke Initiation}
...
```{r Using QuitDate if tobacco_history4 is date}
# txp$tobacco_history4[txp$tobacco_history4 == "" | txp$tobacco_history4 == "N/A"| txp$tobacco_history4 == "NA"] = NA
# txp$SmokeAgeStop = ifelse(is.na(txp$tobacco_history4),
#                           NA,
#                           ifelse(grepl("/",toupper(txp$tobacco_history4)),
#                                  as.Date(strapplyc(txp$tobacco_history4, "\\d+/\\d+/\\d+", simplify = TRUE), "%m/%d/%Y"),
#                                  ifelse(grepl("June",toupper(txp$tobacco_history4)) | grepl("Aug",toupper(txp$tobacco_history4)),
#                                         ))
```
```{r}
txp$tobacco_history4[txp$tobacco_history4 == "" | txp$tobacco_history4 == "N/A"| txp$tobacco_history4 == "NA"] = NA
