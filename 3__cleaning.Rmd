...
txp$at_what_age_did_you_start_smoking_regularly[txp$at_what_age_did_you_start_smoking_regularly == "" | txp$at_what_age_did_you_start_smoking_regularly == "N/A"] == NA #recodes missing
...
txp$SmokeAgeStop = ifelse(txp$at_what_age_did_you_stop_smoking_cigarettes == "" | is.na(txp$at_what_age_did_you_stop_smoking_cigarettes),
                         ifelse(is.na(txp$tobacco_history4),
                                ...
                                ifelse(grepl("/",toupper(txp$tobacco_history4)),
                                       as.integer( as.Date(txp$ConsentDATE) - (as.Date(strapplyc(txp$tobacco_history4, "\\d+/\\d+/\\d+", simplify = TRUE), "%m/%d/%Y")) )/365.25,
