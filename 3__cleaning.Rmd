...
txp$on_average_how_many_packs_per_day_did_you_smoke[txp$on_average_how_many_packs_per_day_did_you_smoke %in% c("N/A","NA","")] = NA
txp$tobacco_history3[txp$tobacco_history3 %in% c("N/A","NA","")] = NA
txp$PackHx = ifelse(is.na(txp$on_average_how_many_packs_per_day_did_you_smoke),
                    ifelse(is.na(txp$tobacco_history3),
                           0,
                           ifelse(txp$tobacco_history3 == "1", ##NEED To trim whitespace
                                  1,
                                  
                    0,
                    
  (txp$on_average_how_many_packs_per_day_did_you_smoke == "" & txp$tobacco_history3 == "") | (),
                    0,
                    )
```
