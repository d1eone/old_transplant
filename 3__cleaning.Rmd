...
txp$SmokeAgeStart = ifelse(is.na(txp$at_what_age_did_you_start_smoking_regularly), 
                           ...
                           as.integer(gsub("[[:space:]]", "", txp$at_what_age_did_you_start_smoking_regularly))
)
```
                         ...
                         ifelse(is.na(txp$tobacco_history4),
                                ...
                                ifelse(grepl("/",toupper(txp$tobacco_history4)),
                                       ...
                                       ifelse(grepl("AGO",toupper(txp$tobacco_history4)),
                                              as.integer( as.Date(txp$ConsentDATE) - as.Date(txp$DOB) )/365.25 - as.integer(gsub("[[:space:]]", "", txp$tobacco_history4)),
                                              as.integer(gsub("[[:space:]]", "", txp$tobacco_history4))
                                       )
                                  )
                          ),
                         ifelse(txp$at_what_age_did_you_stop_smoking_cigarettes == "7 years total",
                                 as.integer( as.Date("1986-01-01") - as.Date(txp$DOB) )/365.25,
                                 as.integer(txp$at_what_age_did_you_stop_smoking_cigarettes)
                         )
)
```
